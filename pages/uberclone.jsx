    ...
    <div className='w-full'>
      <div className='w-screen h-[50vh] relative'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='py-2'>Uber-Clone</h2>
          <h3>Next JS / Tailwind / GoogleAuth /Firebase</h3>
        </div>
      </div>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <p>
            ...
            Tailwind CSS. The application is hosted  using Vercel.
            This is a mobile  recreation of Uber and features
            GoogleAuth for authentication. Users must be   be
          ...
          <a
            href='https://github.com/sumarius56/Uber-Clone-v0.8'
            target='_blank'
            rel='noreferrer'
          >
